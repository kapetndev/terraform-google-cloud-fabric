...
|------|-------------|------|---------|:--------:|
| <a name="input_name"></a> [name](#input\_name) | The name of the VPC network. Must be 1-63 characters long, lowercase, and match `[a-z]([-a-z0-9]*[a-z0-9])?`. Must be unique within the project. | `string` | n/a | yes |
