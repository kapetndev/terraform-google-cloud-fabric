...
```hcl
module "my_vpc" {
  source = "git::https://github.com/kapetndev/terraform-google-cloud-fabric//modules/compute/vpc_network?ref=v0.1.0"
  name   = "my-vpc"
}
```
...
- [minimal-network](../../examples/minimal-network) - Create a VPC with the
