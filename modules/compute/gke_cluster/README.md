...
| <a name="input_name"></a> [name](#input\_name) | Name of the cluster. Used as a prefix for the generated cluster name unless `descriptive_name` is set. | `string` | `null` | no |
