...
output "self_link" {
  description = "The URI of the cluster. Use this to reference the cluster in other GCP resources such as instance groups, load balancer backends, and IAM bindings."
