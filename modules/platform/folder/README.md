...
|------|-------------|------|---------|:--------:|
| <a name="input_display_name"></a> [display\_name](#input\_display\_name) | The human-readable display name of the folder. Must be unique within its parent. | `string` | n/a | yes |
