...
variable "descriptive_name" {
  description = "Fully qualified, authoritative name of the project. When set, `name` is ignored and this value is used directly as the project name with no suffix appended."
  type        = string
  default     = null
}
...
variable "name" {
  description = "The project name. Used as a prefix when generating the project ID unless `project_id` is explicitly set. Mutually exclusive with `descriptive_name`."
  type        = string
  default     = ""
  nullable    = false
}
