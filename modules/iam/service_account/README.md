...
Terraform module to create and manage IAM service accounts within GCP projects,
allowing customisation of display names and descriptions. It provides IAM policy
bindings to control impersonation and management permissions, following the same
authoritative and non-authoritative binding patterns used across other resource
modules.
...
module "cloudsql_service_account" {
  source       = "github.com/kapetndev/terraform-google-cloud-fabric//modules/iam/service_account?ref=v0.1.0"
