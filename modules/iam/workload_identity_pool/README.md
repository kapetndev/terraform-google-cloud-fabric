...
| <a name="output_pool_id"></a> [pool\_id](#output\_pool\_id) | The ID of the Workload Identity Pool. Use this when constructing the Workload Identity member string: `principalSet://iam.googleapis.com/projects/PROJECT_NUMBER/locations/global/workloadIdentityPools/POOL_ID/attribute.ATTRIBUTE/VALUE`. |
