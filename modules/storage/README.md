# terraform-google-storage ![policy](https://github.com/kapetndev/terraform-google-storage/workflows/policy/badge.svg)
...
```hcl
module "my_bucket" {
  source   = "git::https://github.com/kapetndev/terraform-google-storage.git?ref=v0.1.0
  name     = "my-bucket"
