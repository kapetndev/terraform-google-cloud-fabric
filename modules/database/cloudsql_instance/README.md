...
| <a name="input_descriptive_name"></a> [descriptive\_name](#input\_descriptive\_name) | Fully qualified, authoritative name of the primary instance. When set, `name` is ignored and this value is used directly as the instance name with no suffix appended. | `string` | `null` | no |
